...
import { FiUsers, FiMessageSquare, FiFlag, FiStar, FiShield, FiArrowLeft, FiMessageCircle, FiFileText } from "react-icons/fi";
...
const NAV_ITEMS: NavItem[] = [
  ...
  { label: "admin.nav.cvs",     to: "/recruiter/cvs",       Icon: FiFileText },
];
